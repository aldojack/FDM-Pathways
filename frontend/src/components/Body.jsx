    ...
    return (
        <main className="max-w-sm  lg:max-w-5xl mx-auto">
            ...
            <section className="mt-12">
                ...
                <button className="outline-none bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl px-4 py-1 mt-6 hover:from-purple-600 hover:to-blue-600 text-white font-bold"><a href="#">Join now</a></button>
